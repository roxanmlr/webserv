...
# To update sources
# make us
SOURCES = src/main.cpp src/config/Config.cpp src/config/ConfigError.cpp src/config/ConfigParser.cpp src/config/IConfig.cpp src/config/LocationConfigBuilder.cpp src/config/LocationConfig.cpp src/config/ServerConfigBuilder.cpp src/config/ServerConfig.cpp src/config/Tokenizer.cpp src/handler/CgiHandler.cpp src/handler/StaticFileHandler.cpp src/handler/UploadHandler.cpp src/http/HttpRequest.cpp src/http/HttpResponse.cpp src/server/Client.cpp src/server/WebServer.cpp src/server/WebServerError.cpp src/utils/ft_itoa.cpp src/utils/Logger.cpp src/utils/set_nonblocking.cpp
